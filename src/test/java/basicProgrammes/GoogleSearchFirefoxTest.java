...
public class GoogleSearchFirefoxTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//1 set the geckodriver.exe file path System.setproperty(p1,p2)
		//System.setProperty("webdriver.gecko.driver","/Users/Gopireddyparupalli/Desktop/Selenium2022/Executable/geckodriver");
		//Create object for firefox options class
		//FirefoxOptions opt=new FirefoxOptions();
		//opt.setBinary(new File(""/Users/Gopireddyparupalli/Desktop/Selenium2022/Executable/geckodriver)"");
