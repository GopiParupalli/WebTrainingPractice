...
public class GoogleSearchTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[@id='main_navbar']/ul/li[4]/a")).click();
		wait.until(ExpectedConditions.titleContains("The Selenium Browser Automation Project | Selenium"));
